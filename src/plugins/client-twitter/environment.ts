...
export const twitterEnvSchema = z.object({
  ...
  TWITTER_BLACKLIST_TARGET_USERS: z.array(twitterUsernameSchema).default([]),
...
export async function validateTwitterConfig(
  ...
  try {
    const twitterConfig = {
      ...
      // comma separated string
      TWITTER_BLACKLIST_TARGET_USERS: parseTargetUsers(
        runtime.getSetting('TWITTER_BLACKLIST_TARGET_USERS') ||
          process.env.TWITTER_BLACKLIST_TARGET_USERS
      ),
